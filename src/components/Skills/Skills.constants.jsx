...
export const skillCat = {
	web: {
		...
		percentage: 60,
		skillList: [
			{ name: 'HTML', xp: '5 YRS', icon: htmlIcon },
			{ name: 'CSS', xp: '4 YRS', icon: cssIcon },
			...
			{ name: 'Node js', xp: '3 YRS', icon: nodeIcon },
	...
	mobile: {
		...
		percentage: 20,
		skillList: [
			{ name: 'Xamarin', xp: '3 YRS', icon: xamarinIcon },
	...
	tools: {
		...
		percentage: 20,
		skillList: [
			{ name: 'VS 2022 & VS Code Code', xp: '5 YRS', icon: vscodeIcon },
